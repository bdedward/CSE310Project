...
int main(){
	...
	switch(c){		
		...
		case 'R':
			...
			if(numlines < count){
				cout << "Sorry! It cannot be done. The number of elements in file is less than as specified in the beginning of the file.\n";
				break;
			}
		...
		case 'I':
			...
			if(i != 1 && i != 2){
				cout << "\nThis is not a valid flag value. This operation cannot be completed.\n";
				break;
			}
			Insert(heap, i, v);
			break;
